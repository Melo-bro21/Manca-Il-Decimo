...
INSERT INTO "new_Booking" ("createdAt", "id", "matchId", "paymentMethod", "paymentStatus", "status", "updatedAt", "userId") SELECT "createdAt", "id", "matchId", "paymentMethod", "paymentStatus", "status", "updatedAt", "userId" FROM "Booking";
DROP TABLE "Booking";
